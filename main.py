...
photologo = 'https://files.catbox.moe/tg7y3i.jpg' #https://envs.sh/GV0.jpg
photoyt = 'https://files.catbox.moe/tg7y3i.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://files.catbox.moe/tg7y3i.jpg'
photozip = 'https://files.catbox.moe/tg7y3i.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/+3k-1zcJxINYwNGZl"), InlineKeyboardButton(text="🛠️ Repo", url="https://youtu.be/0mRmgOrwWZg")],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://files.catbox.moe/tg7y3i.jpg",
    "https://files.catbox.moe/tg7y3i.jpg",
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://files.catbox.moe/tg7y3i.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://youtu.be/0mRmgOrwWZg")],
        ])
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://files.catbox.moe/tg7y3i.jpg",
        caption=caption
      ),
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                url = f"https://cpapi-rjbs-1l0p.onrender.com/extract_keys?url={url}@bots_updatee&user_id={7188772041}"
                ...
                response = requests.get(f"https://cpapi-rjbs-1l0p.onrender.com/extract_keys?url={url}@bots_updatee&user_id={7188772041}")
